...
% I1, I2 ... image 1 and image 2
% px1,py1 ... x in y coordinates of coresp. points in I1
% px2,py2 ... x in y coordinates of coresp. points in I2
% N ... number of points to display
%       (negative N means random permutation of "-N" elements)
if N < 0
    N = min([-N, length(px1)]) ;

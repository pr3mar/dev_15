...
public:
    ...
    typedef float captype; /* bagon changed  from int to float */

    /* Type of total flow */
	typedef float flowtype; /* bagon changed  from int to float */
...
#define MAKE_ODD(a)  ((arc_forward *) ((POINTER_CAST)(a) | 1))
#define MAKE_EVEN(a) ((arc_forward *) ((POINTER_CAST)(a) & (~1)))
#define MAKE_ODD_REV(a)  ((arc_reverse *) ((POINTER_CAST)(a) | 1))
#define MAKE_EVEN_REV(a) ((arc_reverse *) ((POINTER_CAST)(a) & (~1)))
...
#define NEIGHBOR_NODE_REV(i, shift) ((node *) ((char *)(i) - (shift)))
	...
	{
		POINTER_CAST	shift;		/* node_to = NEIGHBOR_NODE(node_from, shift) */
